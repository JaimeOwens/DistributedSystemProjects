...
var _ = lock.GoUnusedProtection__

func Usage() {
  fmt.Fprintln(os.Stderr, "Usage of ", os.Args[0], " [-h host:port] [-u url] [-f[ramed]] function [arg1 [arg2...]]:")
  flag.PrintDefaults()
  fmt.Fprintln(os.Stderr, "\nFunctions:")
  fmt.Fprintln(os.Stderr, "  Response dolock(Request req)")
  fmt.Fprintln(os.Stderr, "  Response unlock(Request req)")
  fmt.Fprintln(os.Stderr, "  Response client_states()")
  fmt.Fprintln(os.Stderr)
  os.Exit(0)
}
...
func main() {
  ...
  client := lock.NewGetLockClient(thrift.NewTStandardClient(iprot, oprot))
  ...
  case "dolock":
    ...
    value0 := argvalue0
    fmt.Print(client.Dolock(context.Background(), value0))
    fmt.Print("\n")
    break
  case "unlock":
    if flag.NArg() - 1 != 1 {
  ...
  case "client_states":
    ...
    fmt.Print(client.ClientStates(context.Background()))
    fmt.Print("\n")
    break
  case "":
    Usage()
